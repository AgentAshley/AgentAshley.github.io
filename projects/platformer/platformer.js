$(function () {
  ...
  function setup() {
    ...
    createPlatform(50, 80, 200, 10); // short but wide platform located 500 pixels from the left of the screen and 300 pixels from the top of the screen

    createPlatform(500, 300, 20, 50); // long but wide platform located 200 pixels from the left of the screen and 100 pixels from the top of the screen
